...
const PATHS = {
  ...
  video: "M7 4.5h7a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-11a2 2 0 0 1 2-2ZM10 9l4 3-4 3Z",
  volume: "M4 10h3l4-3.5v11L7 14H4ZM15 9a4.2 4.2 0 0 1 0 6M17.5 6.5a7.5 7.5 0 0 1 0 11",
  mute: "M4 10h3l4-3.5v11L7 14H4ZM15 9l5 6M20 9l-5 6",
  wallet: "M4 7.5A2.5 2.5 0 0 1 6.5 5H18v14H6.5A2.5 2.5 0 0 1 4 16.5ZM4 9h14M14 12h6v4h-6a2 2 0 0 1 0-4Z",
  info: "M12 10.5V17M12 7.2v.2M4 12a8 8 0 1 0 16 0 8 8 0 0 0-16 0",
} as const;
...
export function Icon({ name, size = ICONS.sizeInCard, title, ...rest }: IconProps) {
  return (
    <svg data-icon data-directional={DIRECTIONAL.has(name) ? "true" : "false"} viewBox={`0 0 ${ICONS.grid} ${ICONS.grid}`} width={size} height={size} role={title ? "img" : "presentation"} aria-hidden={title ? undefined : true} aria-label={title} {...rest}>
...
export function IconBadge({ name, size = ICONS.sizeInCard }: { name: IconName; size?: number }) {
  return (
    <span className="inline-flex shrink-0 items-center justify-center rounded-icon bg-tint text-hh-2736" style={{ inlineSize: ICONS.containerSize, blockSize: ICONS.containerSize }}>
